...
3.글의 문단(#)의 시작에 **주의 사항이나 참고자료**를 첨언하며 <hr>로 문단 간 분리.
4.글의 정보(##)는 왠만하면 번호를 붙이고 이후에 간단한 설명으로 시작. <br>을 쓰지 않음.
5.글의 세부정보(###) 간의 <br>을 쓰지 않음.
7.설명할 예제는 작은 수평선으로 구분
8.인라인 코드는 핵심 정보를 강조할 때 사용
9.강조는 내용의 핵심을 구분할 때 사용
10.이미지 링크 - 👆<cite>Link</cite>👆, 링크 - 📌 [ ... ](https://...) 📌
11.공지 - {: .notice} ✨...✨
12.글의 세부의 조각 정보는(###)안에 문단을 나눌 때 #### <span style="font-size: medium;">***...***</span>를 사용하자. 
13.☁️밝은 하늘색 color:rgb(169, 190, 213), ☁️덜 밝은 하늘색 color:rgb(144, 153, 175) -->
